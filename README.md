Installing OCP 4.3 with VMware
==============================

For deploying OCP 4.3, a minimum recommendation is to provision 1 ESXi server
...
> **NOTE:**  Openshift 4.3 has a complicated installation.  The official RedHat
> documentation for installing Openshift 4.3 on VMware can be found here:
> [URL](https://docs.openshift.com/container-platform/4.3/installing/installing_vsphere/installing-vsphere.html)
...
```
sudo yum update
sudo yum install ansible genisoimage git epel-release python-pip gcc make openssl-devel python-devel python-requests p7zip* -y 
